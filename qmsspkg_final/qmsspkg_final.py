...
def get_best_teams_api_function(Stats):
    ...
    ['Astros']
    """
    assert Stats in ['Batting_Average', 'Runs_Scored', 'Triples', 'Home_Runs', 'Runs_Batted_In', 'Hits', 'Stolen_Bases', 'ERA', 'Whip', 'Games_Won', 'Strikeouts', 'Games_Saved'], 'Stats should be a valid input'
    import pandas as pd
    ...
    try:
        #Since my API doesn't provide any flexibility in choosing parameters because the
        #choices like seasons has been included in the generated URL, I will only inlcude API as the parameter.
        ...
        print('Success! The status code is: ' + str(response.status_code))
    ...
    #Get the numbers or top Batting Average rank players in each team
    BA_dic = {}
    ...
    #Get the numbers or top Runs Scored rank players in each team
    RS_dic = {}
    ...
    #Get the numbers or top Doubles rank players in each team
    Do_dic = {}
    ...
    #Get the numbers or top Triples rank players in each team
    Tr_dic = {}
    ...
    #Get the numbers or top Home Runs rank players in each team
    HR_dic = {}
    ...
    #Get the numbers or top Runs Batted In rank players in each team
    RBI_dic = {}
    ...
    #Get the numbers or top Hits rank players in each team
    Hit_dic = {}
    ...
    #Get the numbers or top Stolen Bases rank players in each team
    SB_dic = {}
    ...
    #Get the numbers or top ERA rank players in each team
    ERA_dic = {}
    ...
    #Get the numbers or top WHIP rank players in each team
    WHIP_dic = {}
    ...
    #Get the numbers or top Games Won rank players in each team
    GW_dic = {}
    ...
    #Get the numbers or top Strikeouts rank players in each team
    SO_dic = {}
    ...
    #Get the numbers or top Games Saved rank players in each team
    GS_dic = {}
